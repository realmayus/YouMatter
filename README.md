...
## YouMatter
A standalone UU-Matter mod for Forge and NeoForge. Why? Because it matters.

YouMatter is available for `1.12.2` through `1.20.1` on Forge and `1.21.1+` on NeoForge. Check out the respective branches.
...
In order to get started with YouMatter you need to find or craft a Portable Black Hole. This varies depending on what version of YouMatter and Minecraft you are using. You can find these in End City ships if there's no crafting recipe. (You can verify this by checking JEI or a similar mod)
...
**Suggestions? Concerns? Bugs? Please report these to the github or tell us in the realverse discord!**
