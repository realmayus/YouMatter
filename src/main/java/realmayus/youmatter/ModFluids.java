...
public class ModFluids {
    ...
    public static final ForgeFlowingFluid.Properties umatter_properties = new ForgeFlowingFluid.Properties(umatter, umatter_flowing, FluidAttributes.builder(new ResourceLocation(YouMatter.MODID, "block/umatter"), new ResourceLocation(YouMatter.MODID, "block/umatter"))).bucket(umatter_bucket).block(umatter_fluid_block);
