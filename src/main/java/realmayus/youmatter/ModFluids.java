...
public class ModFluids {
    ...
    public static RegistryObject<FluidType> STABILIZER_TYPE = FLUID_TYPES.register("stabilizer", () -> new StabilizerFluidType());
    ...
    public static RegistryObject<StabilizerFluidBlock> STABILIZER_FLUID_BLOCK = BLOCKS.register("stabilizer_fluid_block", () -> new StabilizerFluidBlock(STABILIZER, BlockBehaviour.Properties.of(Material.LAVA).noCollission().strength(1.0F).noLootTable()));
